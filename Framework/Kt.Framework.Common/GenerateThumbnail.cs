...
namespace Kt.Framework.Common
{
    ...
    public class ImageHelper
    {
        ...
        public static MemoryStream GetImage(string code, bool Chaos)
        {
            ...
            string[] Fonts = { "Arial", "Batang", "Verdana", "Microsoft Sans Serif", "Shruti" };//, "Georgia", "Corbel","Corbel", 
            ...
            try
            {
                ...
                for (int i = 0; i < code.Length; i++)
                {
                    ...
                    {
                        f = new System.Drawing.Font(Fonts[0], fSize, System.Drawing.FontStyle.Regular);
                    }
                    else
                    {
